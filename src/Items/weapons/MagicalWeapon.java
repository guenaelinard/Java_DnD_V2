...
//
//public class MagicalWeapon extends OffensiveItem {
//
//    //-------------------------------- CONSTRUCTORS --------------------------------
//
//    public MagicalWeapon(String name, int attackLevel) {
...
//            } else {
//                player.setOffensiveItem(new MagicalWeapon(getWeaponName()));
